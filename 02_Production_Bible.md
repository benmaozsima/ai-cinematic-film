...
Approved designs are stable. Once an element is approved, preserve its description, proportions, references, materials, colors, lighting rules, clothing, silhouette, and continuity constraints unless a new decision explicitly revises it.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CHAR_001 | Shoko A / protagonist | APPROVED | The first Shoko: an older Israeli man, approximately 65-75, who responds to another Shoko's silence by turning a simple check-in into a formal search. Quiet, precise, caring and comically serious. | Canonical natural face and silver-gray hair from the approved reference sheet; lean-to-average build; deliberate posture. | Dark wool trousers, pale button shirt, brown cardigan or jacket, polished dark shoes, dark hat outdoors, wooden walking stick. | Charcoal, faded cream, dark brown, muted olive. No bright modern branding. | Identity, age, hair, wardrobe, hat, stick hand and measured performance remain stable. `Shoko A` is an internal label; on screen he is simply Shoko. | `assets/characters/CHAR_001_reference_sheet_v0.1.png`; supporting approved anchors in `assets/characters/CHAR_001_*.png` | v0.3 |
...
| ID | Name | Status | Description | Geography | Lighting Rules | Palette | Continuity Rules | References | Version |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| ID | Name | Status | Description | Silhouette | Materials | Scale | Continuity Rules | References | Version |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| VEH_001 | TBD | IDEA | TBD | TBD | TBD | TBD | TBD | TBD | v0 |
...
| PROP_002 | Shoko A's dark formal hat | APPROVED | Restrained, slightly old-fashioned dark hat. | Dark felt | Adult | Same brim and crown in all exterior shots; Shoko A only. | `assets/characters/CHAR_001_reference_sheet_v0.1.png` | v0.2 |
